# célula: folha-dois/hml/aurora-cluster
...
terraform {
  # no live real: git::<catalogo>//organismos/folha-dois/aurora-cluster?ref=<tag do catalogo.hcl>
  source = "../../../catalogo//organismos/folha-dois/aurora-cluster"
}
