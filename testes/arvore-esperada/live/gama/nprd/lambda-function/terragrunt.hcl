# célula: gama/nprd/lambda-function
...
terraform {
  # no live real: git::<catalogo>//organismos/gama/lambda-function?ref=<tag do catalogo.hcl>
  source = "../../../catalogo//organismos/gama/lambda-function"
}

# a seta do desenho: trilha. É ela que fixa a ordem de criação.
dependency "s3-bucket" {
  config_path = "../../../gama/delta/nprd/s3-bucket"
