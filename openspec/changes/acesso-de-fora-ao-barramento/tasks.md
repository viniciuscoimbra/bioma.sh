...
- [x] **3.3 O consumo ativo não parou.** _Evidência: o grupo que lia um tópico do barramento manteve atraso máximo 0 em 25 minutos seguidos, cobrindo a janela do apply; a contagem de conexões dos três brokers do cluster não-produtivo ficou entre 3 e 6 na mesma janela, sem queda._
- [x] **3.4 A regra de rede substituiu a do console.** A instalação tinha aberto a porta à mão para destravar o bootstrap. A faixa do código cobre as portas abertas lá. _Evidência: a regra do código nasceu no apply de 3.1; apagar as regras manuais é decisão de quem opera a instalação, e está registrada como pendência com o autor delas._
...
- [x] **4.3 `openspec validate acesso-de-fora-ao-barramento --strict`.** _Evidência: anotada na linha do commit desta change._
